            ...
            <div class="card-body">
                <form action="inquiryformserver.jsp">
                    ...
                    <div class="form-group">
                      ...
                      <input type="email" name="uemail" id="useremail" required class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email">
                      <small id="checkuseremail"></small>
                      </div>
                    <div class="form-group">
                        <label for="exampleInputPhone1">Phone No.</label>
                        <input type="text" name="uphone"  class="form-control" required id="exampleInputPhone1" placeholder="Your Answer">
                      </div>

                    <div class="form-group">
                        <label for="gender">Select Gender</label>
                        <br>
                        <input type="radio" id="gender" name="ugender" required value=male >Male
                        <input type="radio" id="gender" name="ugender" required value=female >Female
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword1">Qualification</label>
                        <input type="text" name="uqualification" required class="form-control" id="exampleInputQualification1" placeholder="Your Answer">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword1">College Name</label>
                        <input type="text" name="ucollege" required class="form-control" id="exampleInputCollegeName1" placeholder="Your Answer">
                      </div>
                      
                       <div class="form-group">
                        <label for="exampleInputPassword1">Date of Enquiry</label>
                        <input type="date" name="udoe" required class="form-control" id="exampleInputCollegeName1">
                      </div>
                      

                      <div class="form-group">
                        <label for="exampleInputPassword1">Select Course</label>
                        <select id="u_select_course" required name="uselectcourse123">
                      ...
                      <div class="form-row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input id="batch" class="form-control " required name="ubatch"  type="text"/><span id="sid11"></span>
								</div>
							</div>
                       ...
                       <div class="form-row">
							<div class="col-md-6">
								<div class="form-group">
									<label >Timing-</label>
									<input id="timing" class="form-control " required name="utiming"  type="text"/>
								</div>
							</div>
						...
						<div class="form-row">
							<div class="col-md-6">
								<div class="form-group">
									<label  >Fees-</label>
									<input id="fees" class="form-control " required name="ufees"  type="text"/>
								</div>
							</div>
						...
						<div class="form-row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input id="capacity" class="form-control " required name="ucapacity"  type="text"/>
								</div>
							</div>
                    <br>
