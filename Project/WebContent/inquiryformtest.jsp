	...
	$("#u_select_course").change(function(){
		...
		$.post("batchserver.jsp",{SELECT_COURSE:u_select_course},function(data,status){
            ...
            String fees="";
              ...
              while(itr.hasNext())
              {
              	batch = (String)itr.next();
              	time = (String) itr.next();
              	fees = (String) itr.next();
              }
            	}
            %>
                      ...
                      <div class="form-group">
                        ...
                        <select id="u_select_course" name="uselectcourseid" form="carform">
                      ...
                      <div class="form-row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input id="batch" class="form-control " name="ubatch" value="<%=batch %>" type="text"/><span id="sid11"></span>
								</div>
							</div>
                       ...
                       <div class="form-row">
							<div class="col-md-6">
								<div class="form-group">
									<label >Timing-</label>
									<input class="form-control " name="utiming" value="<%=time %>"  type="text"/>
								</div>
							</div>
						...
						<div class="form-row">
							<div class="col-md-6">
								<div class="form-group">
									<label  >Fees-</label>
									<input class="form-control " name="ufees" value="<%=fees %>"   type="text"/>
								</div>
							</div>
