		   ...
		   String gender=rs.getString("gender");
                 ...
                 %>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" name="uemail" value="<%=rs.getString(3)%>"id="inputEmailAddress" type="email" aria-describedby="emailHelp" placeholder="Enter email address" />
                                            </div>
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
